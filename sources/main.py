...
def busybox(args, version, url, cross_compile, extra_cfg, config_patches, busybox_src_dir):
    ...
    #     args=args
    # )
    build_busybox(args, work_dir, busybox_src_dir, downloads_dir, cross_compile, rootfs_dir, extra_cfg, config_patches)
...
def main():
    ...
    busybox(args, version, url, cross_compile, extra_cfg, config_patches, busybox_src_dir)
